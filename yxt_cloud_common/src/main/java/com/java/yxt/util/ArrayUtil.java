...
public class ArrayUtil {
    ...
    /**
     * <p>ArrayUtil instances should NOT be constructed in standard programming.
     * Instead, the class should be used as <code>ArrayUtil.clone(new int[] {2})</code>.
     *
     ...
     *
     * <pre>
    String[] array = ArrayUtil.toArray("1", "2");
    String[] emptyArray = ArrayUtil.&lt;String&gt;toArray();
     * </pre>
     *
     ...
     * <code>Number[] array = ArrayUtil.&lt;Number&gt;toArray(Integer.valueOf(42), Double.valueOf(Math.PI))</code>,
     ...
     * Examples:
     * <ul>
     *     <li>ArrayUtil.swap(["1", "2", "3"], 0, 2) -&gt; ["3", "2", "1"]</li>
     *     <li>ArrayUtil.swap(["1", "2", "3"], 0, 0) -&gt; ["1", "2", "3"]</li>
     *     <li>ArrayUtil.swap(["1", "2", "3"], 1, 0) -&gt; ["2", "1", "3"]</li>
     *     <li>ArrayUtil.swap(["1", "2", "3"], 0, 5) -&gt; ["1", "2", "3"]</li>
     *     <li>ArrayUtil.swap(["1", "2", "3"], -1, 1) -&gt; ["2", "1", "3"]</li>
     * </ul>
     *
     ...
     * Examples:
     * <ul>
     *     <li>ArrayUtil.swap([true, false, true], 0, 2) -&gt; [true, false, true]</li>
     *     <li>ArrayUtil.swap([true, false, true], 0, 0) -&gt; [true, false, true]</li>
     *     <li>ArrayUtil.swap([true, false, true], 1, 0) -&gt; [false, true, true]</li>
     *     <li>ArrayUtil.swap([true, false, true], 0, 5) -&gt; [true, false, true]</li>
     *     <li>ArrayUtil.swap([true, false, true], -1, 1) -&gt; [false, true, true]</li>
     * </ul>
     *
     *
     * @param array  the array to swap, may be {@code null}
     ...
     * Examples:
     * <ul>
     *     <li>ArrayUtil.swap([true, false, true, false], 0, 2, 1) -&gt; [true, false, true, false]</li>
     *     <li>ArrayUtil.swap([true, false, true, false], 0, 0, 1) -&gt; [true, false, true, false]</li>
     *     <li>ArrayUtil.swap([true, false, true, false], 0, 2, 2) -&gt; [true, false, true, false]</li>
     *     <li>ArrayUtil.swap([true, false, true, false], -3, 2, 2) -&gt; [true, false, true, false]</li>
     *     <li>ArrayUtil.swap([true, false, true, false], 0, 3, 3) -&gt; [false, false, true, true]</li>
     * </ul>
     *
     * @param array the array to swap, may be {@code null}
     ...
     * Examples:
     * <ul>
     *     <li>ArrayUtil.swap([1, 2, 3, 4], 0, 2, 1) -&gt; [3, 2, 1, 4]</li>
     *     <li>ArrayUtil.swap([1, 2, 3, 4], 0, 0, 1) -&gt; [1, 2, 3, 4]</li>
     *     <li>ArrayUtil.swap([1, 2, 3, 4], 2, 0, 2) -&gt; [3, 4, 1, 2]</li>
     *     <li>ArrayUtil.swap([1, 2, 3, 4], -3, 2, 2) -&gt; [3, 4, 1, 2]</li>
     *     <li>ArrayUtil.swap([1, 2, 3, 4], 0, 3, 3) -&gt; [4, 2, 3, 1]</li>
     * </ul>
     *
     * @param array the array to swap, may be {@code null}
     * @param offset1 the index of the first element in the series to swap
    ...
    */
     ...
     *
     * <pre>
     * ArrayUtil.add(null, null)      = IllegalArgumentException
     ...
     *
     * <pre>
     * ArrayUtil.add(null, 0, null)      = IllegalArgumentException
     ...
     *
     * <pre>
     * ArrayUtil.removeAll(["a", "b", "c"], 0, 2) = ["b"]
     * ArrayUtil.removeAll(["a", "b", "c"], 1, 2) = ["a"]
     * </pre>
     *
     * @param <T> the component type of the array
     * @param array   the array to remove the element from, may not be {@code null}
     ...
     *
     * <pre>
     * ArrayUtil.removeAll([1], 0)             = []
     * ArrayUtil.removeAll([2, 6], 0)          = [6]
     * ArrayUtil.removeAll([2, 6], 0, 1)       = []
     * ArrayUtil.removeAll([2, 6, 3], 1, 2)    = [2]
     * ArrayUtil.removeAll([2, 6, 3], 0, 2)    = [6]
     * ArrayUtil.removeAll([2, 6, 3], 0, 1, 2) = []
     * </pre>
     *
     * @param array   the array to remove the element from, may not be {@code null}
     * @param indices the positions of the elements to be removed
     ...
     *
     * <pre>
     * ArrayUtil.removeAll([true, false, true], 0, 2) = [false]
     * ArrayUtil.removeAll([true, false, true], 1, 2) = [true]
     * </pre>
     *
     * @param array   the array to remove the element from, may not be {@code null}
     * @param indices the positions of the elements to be removed
...
//        }
     ...
     *
     * <pre>
     * ArrayUtil.insert(index, null, null)      = null
     * ArrayUtil.insert(index, array, null)     = cloned copy of 'array'
     * ArrayUtil.insert(index, null, values)    = null
     * </pre>
     *
