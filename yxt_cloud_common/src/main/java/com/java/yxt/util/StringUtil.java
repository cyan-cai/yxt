 ...
 * </ul>
 *
 * <p>The {@code StringUtil} class defines certain words related to
 * String handling.</p>
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>{@code StringUtil} handles {@code null} input Strings quietly.
...
public class StringUtil {
    ...
    /**
     * <p>{@code StringUtil} instances should NOT be constructed in
     * standard programming. Instead, the class should be used as
     * {@code StringUtil.trim(" foo ");}.</p>
     *
     ...
     * StringUtil.truncate("abcdefghijklmno", Integer.MIN_VALUE, 10) = "abcdefghij"
     * StringUtil.truncate("abcdefghijklmno", Integer.MIN_VALUE, Integer.MAX_VALUE) = "abcdefghijklmno"
     ...
     * @since 3.6 Updated {@link CharSequenceUtil} call to behave more like <code>String</code>
     */
   ...
   public static String replaceIgnoreCase(final String text, final String searchString, final String replacement) {
     ...
     * StringUtil.appendIfMissingIgnoreCase("abc", "xyz", "mno") = "axyz"
    ...
    public static String unwrap(final String str, final char wrapChar) {
        if (isEmpty(str) || wrapChar == CharUtil.NUL) {
            return str;
        }
